...
create table partida (
  id int primary key auto_increment, -- Vírgula adicionada aqui
...
create table partida_arbitro (
  ...
  funcao_arbitro varchar(255) not null, -- Ajustado para ser apenas texto e não fk_funcao
